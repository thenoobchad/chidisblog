...
export default async function Home({ params, searchParams }: Props) {
	...
	// read tag as a string from the searchParams object
	const { tag } = searchParams ? await searchParams : { tag: "all" };
	...
	return (
		<>
			<Header />
			<NavigationHeader posts={JSON.parse(JSON.stringify(posts))} />
