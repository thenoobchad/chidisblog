			...
			<div className="flex justify-start px-10 items-center py-6 gap-6 overflow-hidden w-full flex-col">
				<div className="w-full relative">
					...
					<p className="text-sm py-4 font-light leading-6.5 text-justify">
						...
						tempore voluptates incidunt nihil atque quasi quibusdam placeat ea,
						recusandae sed? Rem eius, dolorum ad accusantium quasi a quo
						explicabo fugit voluptatibus quibusdam repellat harum animi itaque
						suscipit dolores dicta facilis nesciunt tenetur? Neque aut aperiam,
						consequatur eveniet voluptas voluptatum commodi. Lorem ipsum dolor
						sit, amet consectetur adipisicing elit. Necessitatibus, similique.
						Quae saepe ea, fuga ex odio non tempora minima, ad atque sapiente
						beatae recusandae amet quo rem incidunt unde reprehenderit.
						<br />
						Lorem ipsum dolor sit amet consectetur, adipisicing elit. Corrupti
						nesciunt similique tenetur, delectus debitis hic culpa! Iure ea,
						magni provident sequi architecto id vitae perspiciatis quis cumque,
						vel repellendus illum esse laudantium repudiandae sint praesentium?
						Sint quas modi id sequi aliquid magni maiores quia eos alias.
						Quisquam, autem vel rerum fugit id obcaecati? Dolores libero rem
						mollitia quisquam voluptatem dolor aliquam placeat! Laborum, sunt
						ipsum est ad quisquam deleniti porro?
					</p>
